...
/**
 * This class is way to big right now. It should probly be built up using composition instead
 ...
 * 
 * 
 * At the start of this project i was not aware that you could make UObjects blueprintable and that would have been very usefull
